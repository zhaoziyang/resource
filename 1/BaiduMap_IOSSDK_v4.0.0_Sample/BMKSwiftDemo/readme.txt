百度地图iOS SDK v4.0.0 swift Sample共有24个Demo,每个Demo的说明如下：

【 新 版 提 示 】
 自v3.3.1起，swift demo语言升级为swift v3.1.
-------------------------------------------------------------------------------------
一、
Demo名称：基本/个性化地图功能
文件名：  MapViewBaseDemoViewController.swift
...
三、
Demo名称：图层展示功能
文件名：  MapViewDemoViewController.swift
...
四、
Demo名称：地图操作功能
文件名：  MapViewControlDemoViewController.swift
...
五、
Demo名称：UI控制功能
文件名：  MapViewUISettingDemoViewController.swift
...
六、
Demo名称：定位功能
文件名：  LocationDemoViewController.swift
...
七、
Demo名称：覆盖物功能
文件名：  AnnotationDemoViewController.swift
...
八、
Demo名称：自定义绘制
文件名：  CustomOverlayDemoViewController.swift
...
九、
Demo名称：POI搜索功能
文件名：  POISearchDemoViewController.swift
...
十、
Demo名称：地理编码功能
文件名：  GeoCodeDemoViewController.swift
...
十一、
Demo名称：路径规划功能
文件名：  RouteSearchDemoViewController.swift
...
十二、
Demo名称：公交线路查询功能
文件名：  BusLineSearchViewController.swift
...
十三、
Demo名称：行政区域边界数据检索
文件名：DistrictSearchDemoViewController.swift
...
十四、
Demo名称：离线地图功能
文件名：  OfflineDemoViewController.swift
...
十六、
Demo名称：短串分享功能
文件名：  ShortUrlShareDemoViewController.swift
...
十七、
Demo名称：LBS.云检索
文件名：  CloudSearchDemoViewController.swift
...
（6）其他注意事项请参考【CloudSearchDemoViewController.swift文件内的注释部分】；
...
十九、
Demo名称：OpenGL绘制功能
文件名：OpenGLDemoViewController.swift
...
二十、
Demo名称：收藏夹功能
文件名：  FavoritesDemoViewController.swift
...
二十一、
Demo名称：周边雷达功能
文件名：  RadarNearbyViewController.swift
...
二十二、
Demo名称：点聚合功能
文件名：  ClusterDemoViewController.swift
m
...
二十三、
Demo名称：瓦片图功能
文件名： TileLayerDemoViewController.swift
...
二十四、
Demo名称：室内功能
文件名： IndoorDemoViewController.swift
简介：展示室内图，并进行室内检索
