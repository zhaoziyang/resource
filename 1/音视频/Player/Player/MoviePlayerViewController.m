...
- (void)viewDidLoad {
    ...
    // 创建AVPlayer
    self.playerItem = [AVPlayerItem playerItemWithURL:[NSURL URLWithString:@"http://v.baidu.com/link?url=dm_00pw_klemzFaU2vO4w7zo2Cc1yuX_dCEHtgd-yB9KwhC-tqPQIQDpQkRn6zaM4-Kc5mGTxA41v4oBrf9wwl7KhwpypQc-R1pWFqkL6XMBcZXDqmEj5jM0.&page=videoMultiNeed"]];
