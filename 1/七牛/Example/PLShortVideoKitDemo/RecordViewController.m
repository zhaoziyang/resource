...
@property (strong, nonatomic) PLSVideoConfiguration *videoConfiguration;//配置摄像头参数
@property (strong, nonatomic) PLSAudioConfiguration *audioConfiguration;//配置麦克风参数
@property (strong, nonatomic) PLShortVideoRecorder *shortVideoRecorder; //负责视频的拍摄
